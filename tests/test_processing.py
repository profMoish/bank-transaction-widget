...
def test_filter_by_state(_list: list) -> None:
    ...
    filtered = filter_by_state(_list, "CANCELED")
    assert filtered == [
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
    ]
...
def test_sort_by_date(_list: list) -> None:
    ...
    sorted = sort_by_date(_list, True)
    assert sorted == [
        {"id": 414288290, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
    ...
    sorted = sort_by_date(_list, False)
    assert sorted == [
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
    ...
    sorted = sort_by_date([], True)
    assert sorted == []


def test_sort_by_date_not_standart() -> None:
